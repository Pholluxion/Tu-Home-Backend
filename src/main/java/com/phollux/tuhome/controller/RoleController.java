...
import com.phollux.tuhome.service.RoleService;
...
public class RoleController {
    ...
    public String add(@ModelAttribute("role") @Valid final RoleDTO roleDTO,
        ...
        if (!bindingResult.hasFieldErrors("name") && roleService.nameExists(roleDTO.getName())) {
    ...
    public String edit(@PathVariable final Long id,
        ...
        final RoleDTO currentRoleDTO = roleService.get(id);
        if (!bindingResult.hasFieldErrors("name") &&
                !roleDTO.getName().equalsIgnoreCase(currentRoleDTO.getName()) &&
                roleService.nameExists(roleDTO.getName())) {
            bindingResult.rejectValue("name", "Exists.role.name");
        }
        if (bindingResult.hasErrors()) {
            return "role/edit";
